...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-5 border rounded-2xl [--cell-size:2em] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-8 w-8 select-none p-0 aria-disabled:opacity-50 hover:bg-muted rounded-full transition-all",
        ...
        month_caption: cn(
          "flex h-[--cell-size] w-full items-center justify-center px-[--cell-size] text-lg font-bold tracking-tight text-foreground",
        ...
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-[0.8rem] font-medium uppercase tracking-wider",
        ...
        today: cn(
          "bg-accent/30 text-accent-foreground rounded-full border border-primary/20",
